...
const Contact = ({ offset }: { offset: number }) => (
  <div>
    ...
    <Divider speed={0.1} offset={offset}>
      ...
      <UpDownWide>
        <SVG icon="triangle" width={12} color="icon_yellow" left="95%" top="50%" />
        <SVG icon="triangle" width={6} color="icon_darkest" left="85%" top="15%" />
      ...
      <SVG icon="triangle" width={12} color="icon_yellow" left="70%" top="60%" />
      <SVG icon="triangle" width={12} color="icon_yellow" left="20%" top="30%" />
